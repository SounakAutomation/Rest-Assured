...
public class PutUpdateBookingTest extends TestBase {
    String extenedUrl;
    PutUpdateBooking putUpdateBooking;
    ...
    public void initialize(){
        ...
        putUpdateBooking = new PutUpdateBooking();
    ...
    public void beforeTest() {
        ...
        data.lastname="roy";
        data.additionalneeds="launch";
        data.checkin="2018-01-01";
        data.checkout="2018-01-01";
        data.totalprice=7677;
    ...
    @Test
    public void PutUpdateBookingTest01_WhenValidRequst_ShouldReturn200()
    {
        createBookingRequestPayload = new CreateBookingRequest(data);
        payload=createBookingRequestPayload.createBookingPayload();
        headers.add(new Header("Cookie", "token="+data.token));
        Response response=putUpdateBooking.putUpdateBooking(payload, extenedUrl,headers);
        RestValidation.validateStatusCode(response,200);
    }
    @Test
    public void PutUpdateBookingTest02_WhenTokenInvalid_ShouldReturn403()
    {
        createBookingRequestPayload = new CreateBookingRequest(data);
        payload=createBookingRequestPayload.createBookingPayload();
        headers.add(new Header("Cookie", "token="+2232));
        Response response=putUpdateBooking.putUpdateBooking(payload, extenedUrl,headers);
        RestValidation.validateStatusCode(response,403);
    }
